...
<head>
    ...
    <title>Dashboard Petugas Kebersihan - Sistem Sampah Digital Kampus</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Dashboard Petugas Kebersihan</h1>
    ...
    <div class="container">
        <div class="welcome">
            ...
            <p>Kelola laporan sampah elektronik dengan mudah</p>
        </div>

        <div class="menu">
            <a href="laporan_petugas.php" class="menu-item">
                <h3>📋 Lihat Laporan</h3>
                <p>Lihat semua laporan sampah yang diajukan</p>
            </a>
            <a href="manage_pengumuman.php" class="menu-item">
                <h3>📢 Kelola Pengumuman</h3>
                <p>Tambah dan kelola pengumuman untuk mahasiswa</p>
            </a>
        </div>
